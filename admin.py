...
async def admin(id,id_pokupat):
    ...
    if id_pokupat !=0:
        ...
        bat2 = types.InlineKeyboardButton(text='Рассылка', callback_data='write_message')
        bat3 = types.InlineKeyboardButton(text='БАЗА', callback_data='solve')
        murkap.add(bat1,bat2,bat3)
